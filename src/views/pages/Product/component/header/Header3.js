                ...
                <div className="Header-section1">
                    ...
                    <div className="Header-container-icon">
                        ...
                        {/* <select className>
                            ...
                            <option to="/CustomerView" data-icon="" >
                                Customer View
                            </option>
                            <option data-icon="" >
                                Sign Out
                        ...
                        <CButtonGroup>
                        <CButton onClick={this.saveDataAction} >Admin</CButton>
                        <CDropdown >
                            <CDropdownToggle caret  selected>
                            </CDropdownToggle>
                            <CDropdownMenu>
                                <CDropdownItem to="/SimpleProduct">Save</CDropdownItem>
                                <CDropdownItem to="/CustomerView"> Customer View</CDropdownItem>
                                <CDropdownItem > Sign Out</CDropdownItem>
